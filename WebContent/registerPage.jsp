...
<form action="Register" method="post">
  <div class="container">
    ...
    <label for="psw"><b>Employee EmailId</b></label>
    ...
    <label for="psw-repeat"><b>Employee Department</b></label>
    <select name="selectdept" >
         <option value"production">Production</option>
            <option value"research&development">Research and Development</option>
            <option value"purchasing">Purchasing</option>
            <option value"marketing">Marketing</option>
            <option value"humanResource&management">Human Resource and Management</option>
            <option value"account&finance">Account and Finance</option>
            </select>
    <hr>
